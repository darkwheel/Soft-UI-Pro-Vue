<template>
  <div class="home-container">
    ...
    <img
      alt="image"
      src="/playground_assets/curved6-1200w.jpg"
      class="home-image04"
    />
    <section class="home-features">
      ...
      ></feature-card>
      <feature-card image_src="/playground_assets/person1.svg"></feature-card>
      <feature-card
          ...
          <div class="home-container11">
            ...
            <p>
              ...
              <span class="home-text16">
                ...
                year-by-year, for all kinds of natural reasons, thereâs huge
          ...
          <div class="home-container14">
            ...
            <p class="home-text26 body">
              <span class="home-text27">
                ...
                leave every other idea alone. This is the way to success. A single
      ...
      <div class="home-container32">
        <div class="home-container33">
          ...
          <div class="home-container35">
            ...
            <outline-black-button button="get started"></outline-black-button>
          </div>
        </div>
