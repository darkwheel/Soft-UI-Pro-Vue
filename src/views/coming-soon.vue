    ...
    <div class="coming-soon-container1">
      <div class="coming-soon-main">
        ...
        <div class="coming-soon-grid">
          <img
            alt="image"
            src="/playground_assets/iphone-3-200w.png"
            class="coming-soon-image"
          />
          <img
            alt="image"
            src="/playground_assets/iphone-2-200w.png"
            class="coming-soon-image01"
          />
          <img
            alt="image"
            src="/playground_assets/iphone-4-200w.png"
            class="coming-soon-image02"
          />
          <img
            alt="image"
            src="/playground_assets/iphone-1-200w.png"
